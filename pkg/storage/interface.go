...
type FileSystem interface {
	...
	//Access Token
	AccessToken(ctx context.Context) (cred *Credentials, err error)
	PresignUpload(ctx context.Context, bucket string, uploadKey string, lifetimeSecs int64) (url string, err error)
