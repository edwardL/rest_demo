...
func (r *Cos) AccessToken(ctx context.Context) (cred *Credentials, err error) {
	return nil, nil
}

func (r *Cos) PresignUpload(ctx context.Context, bucket, uploadKey string, lifetimeSecs int64) (url string, err error) {
	return "", nil
}
